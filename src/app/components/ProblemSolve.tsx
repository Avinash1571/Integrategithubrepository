      ...
      <div className="max-w-[1280px] mx-auto px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 mb-14 items-start">
          <div>
            ...
            >
              <p>
                RAMS analysis is one of engineering's most rigorous disciplines. But the tooling has barely moved since the 1980s. Most teams run a patchwork of Windows desktop applications — or live in Excel. Either way, work lives in silos, versions drift, and the analyst becomes the bottleneck.
              </p>
              <p>
                RAMS360 was built to fix this exactly. Ten modules — from PBS to Reports — in a single browser-based platform where every data point is live-linked, every change propagates automatically, and every team member has the right access.
              </p>
            </div>
          </div>
          <div>
            <div className="rounded-lg bg-[#1a1a2e] px-6 py-5">
              <p
        ...
        <div className="rounded-2xl overflow-hidden border border-gray-200/80 shadow-[0_8px_48px_rgba(0,0,0,0.09)]">
          ...
          >
            <defs>
              {/* Backgrounds */}
              <linearGradient id="psBeforeBg" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#EDE7F6" />
                <stop offset="100%" stopColor="#E2DAF0" />
              </linearGradient>
              ...
              <linearGradient id="psCenterBg" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#E2DAF0" />
                <stop offset="50%" stopColor="#ECE6F8" />
                <stop offset="100%" stopColor="#E8EEFF" />
              </linearGradient>
              {/* Hub gradient */}
            ...
            <rect x="0" y="0" width="1100" height="460" fill="white" />
            ...
            {/* ═══════════════════ CENTER TRANSITION ═══════════════════ */}
            <rect x="490" y="0" width="122" height="460" fill="url(#psCenterBg)" />
            <line x1="490" y1="28" x2="490" y2="432" stroke="#C6BAE0" strokeWidth="0.8" strokeDasharray="3,4" />
            <line x1="612" y1="28" x2="612" y2="432" stroke="#C2CCEE" strokeWidth="0.8" strokeDasharray="3,4" />

            {/* Arrow */}
            <g transform="translate(551, 228)">
              <rect x="-22" y="-3.5" width="44" height="7" rx="3.5" fill="#432975" fillOpacity="0.12" />
              <polygon points="18,-9 35,0 18,9" fill="#432975" fillOpacity="0.65" />
              <polygon points="-4,-9 13,0 -4,9" fill="#432975" fillOpacity="0.3" />
            </g>

            {/* RAMS360 pill */}
            <rect x="507" y="196" width="88" height="26" rx="13" fill="#432975" filter="url(#psGlowSm)" />
            <text x="551" y="213" textAnchor="middle" fontSize="9.5" fontFamily="system-ui, sans-serif" fill="white" fontWeight="700" letterSpacing="0.5">RAMS360</text>
            <text x="551" y="248" textAnchor="middle" fontSize="7.5" fontFamily="system-ui, sans-serif" fill="#7A6898">transforms into</text>

            {/* ═══════════════════ AFTER SIDE ═══════════════════ */}
            <g clipPath="url(#psAfterClip)">
              <rect x="612" y="0" width="488" height="460" fill="url(#psAfterBg)" />
              <rect x="612" y="0" width="488" height="460" fill="url(#psGridLight)" />

              {/* AFTER badge */}
              <rect x="622" y="16" width="116" height="23" rx="11.5" fill="#059669" />
              <text x="680" y="31" textAnchor="middle" fontSize="9" fontFamily="system-ui, sans-serif" fill="white" fontWeight="700" letterSpacing="0.8">AFTER RAMS360</text>
              ...
              {/* Logo mark */}
              <rect x="644" y="93" width="8" height="8" rx="2" fill="#E8722A" />
              <text x="658" y="104" fontSize="9" fontFamily="system-ui, sans-serif" fill="white" fontWeight="700">RAMS360</text>
              {/* Nav links */}
              ...
              {/* ── Status badges (inside browser, bottom) ── */}
              {/* Audit Trail */}
              <rect x="638" y="406" width="90" height="22" rx="6" fill="#F0F4FF" stroke="#CDD4F0" strokeWidth="0.8" />
              <text x="683" y="417" textAnchor="middle" fontSize="6.5" fontFamily="system-ui, sans-serif" fill="#432975" fontWeight="600">Audit Trail: ON</text>
              <text x="683" y="425" textAnchor="middle" fontSize="5.2" fontFamily="system-ui, sans-serif" fill="#9CA3AF">All changes tracked</text>
